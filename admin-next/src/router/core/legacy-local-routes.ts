...
export const localLegacyRoutes: LegacyRouteRecord[] = [
  ...
  group('Admin', '/admin', '后台管理', 'ic:round-settings-input-composite', '/admin/settings', [
    ...
    group(
      ...
      '/admin/settings',
      [
        leaf('AdminSettings', '/admin/settings', '系统设置', 'mdi:tune-variant', ['super', 'admin']),
        leaf('AdminAnnouncements', '/admin/announcements', '公告管理', 'mdi:bullhorn-outline', ['super', 'admin']),
    ...
    group(
      ...
      [
        ...
        leaf('AdminSuppliers', '/admin/suppliers', '货源管理', 'mdi:store-outline', ['super', 'admin']),
        leaf('AdminCategories', '/admin/categories', '分类管理', 'mdi:file-tree-outline', ['super', 'admin']),
    ...
    group(
      ...
      [
        ...
        leaf('AdminTickets', '/admin/tickets', '工单管理', 'mdi:ticket-outline', ['super', 'admin']),
        leaf('AdminCheckin', '/admin/checkin', '签到管理', 'mdi:calendar-check-outline', ['super', 'admin'])
      ],
      ['super', 'admin']
    ),
    group(
      ...
      '/admin/email-pool',
      [
        leaf('AdminEmailPool', '/admin/email-pool', '邮箱轮询池', 'mdi:mailbox-outline', ['super', 'admin']),
        leaf('AdminMail', '/admin/mail', '邮件群发', 'mdi:send-outline', ['super', 'admin']),
        leaf('AdminEmailTemplates', '/admin/email-templates', '邮件模板', 'mdi:file-code-outline', ['super', 'admin']),
        leaf('AdminEmailLogs', '/admin/email-logs', '发送日志', 'mdi:file-document-outline', ['super', 'admin'])
      ],
      ['super', 'admin']
    ),
    group(
      ...
      [
        leaf('AdminUpstreamConfig', '/admin/upstream-config', '对接中心', 'mdi:transit-connection-variant', ['super', 'admin']),
        leaf('AdminPlatformConfig', '/admin/platform-config', '平台配置', 'mdi:api', ['super', 'admin']),
        leaf('AdminMiJia', '/admin/mijia', '密价设置', 'mdi:lock-outline', ['super', 'admin']),
        leaf('AdminModules', '/admin/modules', '模块管理', 'mdi:puzzle-outline', ['super', 'admin']),
        leaf('AdminSyncMonitor', '/admin/sync-monitor', '商品同步监控', 'mdi:sync-circle', ['super', 'admin']),
        leaf('AdminDockScheduler', '/admin/queue', '待对接调度', 'mdi:timer-sync-outline', ['super', 'admin']),
        leaf('AdminOrderProgressSync', '/admin/order-progress-sync', '主订单同步', 'mdi:progress-clock', ['super', 'admin'])
      ],
      ['super', 'admin']
    ),
    group(
      ...
      [
        leaf('AdminRankSuppliers', '/admin/rank-suppliers', '货源排行', 'mdi:trophy-outline', ['super', 'admin']),
        leaf('AdminRankAgentProducts', '/admin/rank-agent-products', '代理统计', 'mdi:chart-timeline-variant', ['super', 'admin']),
        leaf('AdminMoneyLog', '/admin/moneylog', '全站流水', 'mdi:cash-register', ['super', 'admin']),
        leaf('AdminWithdraw', '/admin/withdraw', '商家提现审核', 'mdi:storefront-outline', ['super', 'admin']),
        leaf('AdminMallCUserWithdraw', '/admin/mall-cuser-withdraw', '会员佣金提现审核', 'mdi:cash-refund', ['super', 'admin'])
      ],
      ['super', 'admin']
    ),
    leaf('AdminTenants', '/admin/tenants', '租户管理', 'mdi:store-cog-outline', ['super', 'admin']),
    group(
      'AdminAuxGroup',
      '/admin/aux',
      '辅助业务',
      ...
      '/admin/cardkeys',
      [
        leaf('AdminCardKeys', '/admin/cardkeys', '卡密管理', 'mdi:credit-card-plus-outline', ['super', 'admin']),
        leaf('AdminActivities', '/admin/activities', '活动管理', 'mdi:gift-outline', ['super', 'admin']),
        leaf('AdminPledge', '/admin/pledge', '质押管理', 'mdi:shield-lock-outline', ['super', 'admin'])
      ],
      ['super', 'admin']
    ),
    leaf('AdminOpsDashboard', '/admin/ops', '运维看板', 'mdi:monitor-dashboard', ['super', 'admin']),
    {
      name: 'AdminDbCompat',
