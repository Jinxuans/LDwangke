	...
	return []TableDef{
		{
			...
			Columns: []ColumnDef{
				...
				{Name: "mall_money", Type: "DECIMAL(12,4)", NotNull: false, Default: "0"},
				{Name: "mall_cdmoney", Type: "DECIMAL(12,4)", NotNull: false, Default: "0"},
		...
		},
		{
			...
			Columns: []ColumnDef{
				...
				{Name: "tid", Type: "INT(11)", NotNull: false, Default: "0"},
				{Name: "c_uid", Type: "INT(11)", NotNull: false, Default: "0"},
				{Name: "retail_fees", Type: "DECIMAL(10,2)", NotNull: false, Default: "0"},
		...
		{Name: "qingka_withdraw_request", PrimaryKey: "id", AutoInc: true,
			Columns: []ColumnDef{
				{Name: "id", Type: "INT(11)", NotNull: true},
				{Name: "uid", Type: "INT(11)", NotNull: false, Default: "0"},
				{Name: "amount", Type: "DECIMAL(10,2)", NotNull: false, Default: "0"},
				{Name: "method", Type: "VARCHAR(32)", NotNull: false, Default: "'manual'"},
				{Name: "account_name", Type: "VARCHAR(100)", NotNull: false, Default: "''"},
				{Name: "account_no", Type: "VARCHAR(120)", NotNull: false, Default: "''"},
				{Name: "bank_name", Type: "VARCHAR(120)", NotNull: false, Default: "''"},
				{Name: "note", Type: "VARCHAR(255)", NotNull: false, Default: "''"},
				{Name: "status", Type: "TINYINT(4)", NotNull: false, Default: "0"},
				{Name: "audit_remark", Type: "VARCHAR(255)", NotNull: false, Default: "''"},
				{Name: "audit_uid", Type: "INT(11)", NotNull: false, Default: "0"},
				{Name: "addtime", Type: "DATETIME", NotNull: false},
				{Name: "audit_time", Type: "DATETIME", NotNull: false},
			},
		},
		{
			Name: "qingka_mall_pay_order", PrimaryKey: "id", AutoInc: true,
			Columns: []ColumnDef{
				{Name: "id", Type: "INT(11)", NotNull: true},
				{Name: "out_trade_no", Type: "VARCHAR(64)", NotNull: false, Default: "''"},
				{Name: "trade_no", Type: "VARCHAR(64)", NotNull: false, Default: "''"},
				{Name: "tid", Type: "INT(11)", NotNull: false, Default: "0"},
				{Name: "cid", Type: "INT(11)", NotNull: false, Default: "0"},
				{Name: "c_uid", Type: "INT(11)", NotNull: false, Default: "0"},
				{Name: "school", Type: "VARCHAR(255)", NotNull: false, Default: "''"},
				{Name: "account", Type: "VARCHAR(128)", NotNull: false, Default: "''"},
				{Name: "password", Type: "VARCHAR(128)", NotNull: false, Default: "''"},
				{Name: "remark", Type: "VARCHAR(255)", NotNull: false, Default: "''"},
				{Name: "pay_type", Type: "VARCHAR(32)", NotNull: false, Default: "''"},
				{Name: "money", Type: "DECIMAL(10,2)", NotNull: false, Default: "0"},
				{Name: "status", Type: "TINYINT(4)", NotNull: false, Default: "0"},
				{Name: "order_id", Type: "INT(11)", NotNull: false, Default: "0"},
				{Name: "course_id", Type: "VARCHAR(64)", NotNull: false, Default: "''"},
				{Name: "course_name", Type: "VARCHAR(255)", NotNull: false, Default: "''"},
				{Name: "course_kcjs", Type: "VARCHAR(64)", NotNull: false, Default: "''"},
				{Name: "course_items", Type: "TEXT", NotNull: false},
				{Name: "promoter_c_uid", Type: "INT(11)", NotNull: false, Default: "0"},
				{Name: "promoter_code", Type: "VARCHAR(64)", NotNull: false, Default: "''"},
				{Name: "commission_rate", Type: "DECIMAL(5,2)", NotNull: false, Default: "0"},
				{Name: "commission_amount", Type: "DECIMAL(10,2)", NotNull: false, Default: "0"},
				{Name: "commission_status", Type: "TINYINT(4)", NotNull: false, Default: "0"},
				{Name: "addtime", Type: "DATETIME", NotNull: false},
				{Name: "paytime", Type: "DATETIME", NotNull: false},
			},
		},
	}
}
