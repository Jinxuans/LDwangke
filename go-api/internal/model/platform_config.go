...
type PlatformConfigDB struct {
	...
	BatchProgressPath     string    `json:"batch_progress_path" db:"batch_progress_path"`
	BatchProgressMethod   string    `json:"batch_progress_method" db:"batch_progress_method"`
	BatchProgressBodyType string    `json:"batch_progress_body_type" db:"batch_progress_body_type"`
	BatchProgressParamMap string    `json:"batch_progress_param_map" db:"batch_progress_param_map"`
...
type PlatformConfigSaveRequest struct {
	...
	BatchProgressPath     string `json:"batch_progress_path"`
	BatchProgressMethod   string `json:"batch_progress_method"`
	BatchProgressBodyType string `json:"batch_progress_body_type"`
	BatchProgressParamMap string `json:"batch_progress_param_map"`
