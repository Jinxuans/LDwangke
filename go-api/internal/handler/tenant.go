...
func AdminTenantList(c *gin.Context) {
	...
	list, total, err := tenantService.List(page, limit)
	if err != nil {
...
func AdminTenantCreate(c *gin.Context) {
	...
	tid, err := tenantService.Create(req.UID, &req)
	if err != nil {
...
func AdminTenantSetStatus(c *gin.Context) {
	...
	if err := tenantService.SetStatus(tid, req.Status); err != nil {
...
func TenantShopGet(c *gin.Context) {
	uid := c.GetInt("uid")
	t, err := tenantService.GetByUID(uid)
	if err != nil {
...
func TenantShopSave(c *gin.Context) {
	...
	// 检查是否已有店铺
	t, _ := tenantService.GetByUID(uid)
	if t == nil {
		// 新建
		req.UID = uid
		tid, err := tenantService.Create(uid, &req)
		if err != nil {
			response.BusinessError(c, 1001, err.Error())
			return
		}
	...
	if err := tenantService.UpdateShop(uid, &req); err != nil {
...
func TenantPayConfigSave(c *gin.Context) {
	...
	if err := tenantService.UpdatePayConfig(uid, req.PayConfig); err != nil {
		response.ServerError(c, "保存失败")
		return
	}
	response.SuccessMsg(c, "保存成功")
...
func TenantProductList(c *gin.Context) {
	...
	list, err := tenantService.ProductList(t.TID)
	if err != nil {
		response.ServerError(c, "查询失败")
		return
	}
...
func TenantProductSave(c *gin.Context) {
	...
	if err := tenantService.ProductSave(t.TID, &req); err != nil {
		response.ServerError(c, "保存失败")
		return
	}
	response.SuccessMsg(c, "保存成功")
...
func TenantProductDelete(c *gin.Context) {
	...
	if err := tenantService.ProductDelete(t.TID, cid); err != nil {
...
func TenantOrderStats(c *gin.Context) {
	...
	stats, err := tenantService.TenantOrderStats(t.TID)
	if err != nil {
		response.ServerError(c, "查询失败")
		return
	}
...
func TenantCUserList(c *gin.Context) {
	...
	page, _ := strconv.Atoi(c.DefaultQuery("page", "1"))
	limit, _ := strconv.Atoi(c.DefaultQuery("limit", "20"))
	list, total, err := tenantService.CUserList(t.TID, page, limit)
	if err != nil {
		response.ServerError(c, "查询失败")
		return
	}
...
func TenantCUserSave(c *gin.Context) {
	...
	if err := tenantService.CUserSave(t.TID, &req); err != nil {
...
func TenantCUserDelete(c *gin.Context) {
	...
	if err := tenantService.CUserDelete(t.TID, id); err != nil {
...
func TenantMallOrders(c *gin.Context) {
	...
	page, _ := strconv.Atoi(c.DefaultQuery("page", "1"))
	limit, _ := strconv.Atoi(c.DefaultQuery("limit", "20"))
	list, total, err := tenantService.TenantMallOrders(t.TID, page, limit)
	if err != nil {
		response.ServerError(c, "查询失败")
		return
	}
