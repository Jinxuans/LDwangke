  ...
  <div class="app-content-body">
    <div class="wrapper-md control" id="pangu">
      ...
      <el-card class="box-card">
        <el-alert title="下单前请先完成授权,授权地址：https://ydsjauth.666hhh.sbs/" type="warning"></el-alert>
        <div style="height: 10px"></div>
        <el-button type="primary" @click="()=>{addDialog = true}" size="small" plain>提交订单</el-button>
        <el-button type="success" @click="()=>{window.open('https://ydsjauth.666hhh.sbs/', '_blank')}" size="small" plain>授权链接</el-button>
        ...
        <el-table :data="tableData" v-loading="tableLoading" element-loading-text="载入数据中" ref="multipleTable"
          ...
          <el-table-column label="跑步类型" width="100" align="center">
            <template slot-scope="{ row }">
              <el-tag type="success">学分跑</el-tag>
            </template>
          </el-table-column>
        ...
        <el-form label-width="90px">
          ...
          <el-form-item label="跑步类型">
            <el-radio-group v-model="addForm.runType" size="small">
              <el-radio-button :label="1">学分跑</el-radio-button>
            </el-radio-group>
          </el-form-item>
...
<script src="/pangu/static/pgydsj.js"></script>