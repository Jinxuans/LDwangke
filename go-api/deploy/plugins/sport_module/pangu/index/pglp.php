  ...
  <div class="app-content-body">
    <div class="wrapper-md control" id="pangu">
      ...
      <el-card class="box-card">
        <el-alert title="下单前请先完成授权,授权地址：https://120.26.43.70/lpauth/#/" type="warning"></el-alert>
        <div style="height: 10px"></div>
        <el-button type="primary" @click="()=>{addDialog = true}" size="small" plain>提交订单</el-button>
        <el-button type="success" @click="()=>{window.open('https://120.26.43.70/lpauth/#/', '_blank')}" size="small" plain>授权链接</el-button>
...
<script src="/pangu/static/pglp.js"></script>