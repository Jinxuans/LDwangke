...
async fn main() {
    ...
    let admin_routes = Router::new()
        ...
        .route("/licenses/export", get(handler::admin_export))
        ...
        .route("/license/batch_create", post(handler::admin_batch_create))
        .route("/license/batch_revoke", post(handler::admin_batch_revoke))
        .route("/license/batch_renew", post(handler::admin_batch_renew))
        .route("/license/batch_enable", post(handler::admin_batch_enable))
        .route("/license/batch_delete", post(handler::admin_batch_delete))
        .route("/license/batch_unbind", post(handler::admin_batch_unbind))
        .route("/license/logs", get(handler::admin_logs))
        .route("/license/cleanup_logs", post(handler::admin_cleanup_logs))
        .route("/license/dashboard", get(handler::admin_dashboard))
        .route("/notices", get(handler::admin_notice_list))
        .route("/notice/create", post(handler::admin_notice_create))
        .route("/notice/update", post(handler::admin_notice_update))
        .route("/notice/delete/:id", delete(handler::admin_notice_delete))
        .route("/stats/trend", get(handler::admin_stats_trend))
        .route("/stats/distribution", get(handler::admin_stats_distribution))
        ...
        .route("/change_password", post(handler::change_password))
